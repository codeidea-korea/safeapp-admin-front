...
?>
    <!-- CONTENTS s -->
    <div class="content mt50" id="adm_inquiry_answer">
      <!-- 컨텐츠 공통 헤드 s-->
      <div class="com_head">
        ...
        <div class="box">
          ...
          <div class="box-content">
            ...
            <span class="form_btn btn btn_g mr5" onclick="location.href='adm_cs_list.php'">목록</span>
              <span class="form_btn btn btn_m" onclick="location.href='adm_inquiry_detail.php'">답변</span>
            </div>
          </div>
        </div>
      </div>
