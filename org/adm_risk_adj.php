      ...
      <section id="adj" class="cont mb30">
        <article class="cont_box mt30">
          ...
          <div class="title mt20">
            <input type="text" name="list_title" id="list_title" class="fwb fs-xlg pa20" value="굴착작업 위험성 평가">
          </div>
          <div class="mybutton">
        ...
        <article class="cont_box check-work mt30">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <input type="text" value="굴착 장비반입">
                </td>
                <td>
                  <input type="text" value="a-1">
                </td>
                <td>
                  <input type="text" value="굴삭기">
                </td>
                <td>
                ...
                <td>
                  <input type="text" value="굴삭기 운전원의 운전미숙으로 전도, 충돌">
                </td>
                <td>
                  <input type="text" value="안전보건규">
                </td>
                <td>
                  <select name="search_type">
