...
?>
    ...
    <!-- CONTENTS s -->
    <div class="content mt50" id="check_list">
      <!-- 컨텐츠 공통 헤드 s-->
          ...
          <div class="box">
            ...
            <div class="box-content">
              ...
              <div class="board_area">
                ...
                <div class="board_list_wrap">
                  <ul class="board">
                    ...
                    <li class="th_15">
                      <div class="btn form_btn btn_m" onclick="location.href='adm_check_contents.php'">템플릿 열기</div>
                    </li>
                  </ul>
                  <ul class="board">
                    <li class="th_5 tac">
              ...
              <div class="tar mt10">
                  ...
                  <span class="form_btn btn btn_m" onclick="location.href='adm_check_write.php'">작성하기</span>
                </div>
            </div>
