...
?>
    <!-- CONTENTS s -->
    <main class="content mt50" id="adm_near_list">
      <!-- 컨텐츠 공통 헤드 s-->
        ...
        <div class="box">
          ...
          <div class="box-content">
            <div class="statis_box wrap">
              <div class="tab_menu">
                <ul class="list">
                  <li class="is_on"><a href="adm_near_list.php" class="statis_btn">아차사고 목록</a></li>
                  <li><a href="adm_near_dec_list.php" class="statis_btn">신고 목록</a></li>
                </ul>
              </div>
              ...
              <div class="tar mt10">
                <span class="form_btn btn btn_g mr5" onclick="javascript:openModal('cancel');">삭제</span>
                  <span class="form_btn btn btn_m"  onclick="location.href='adm_near_write.php'">작성하기</span>
              </div>
